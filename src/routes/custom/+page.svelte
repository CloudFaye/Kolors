...
<div class="page-container animate-item" onclick={() => {}}>
	<section class="hero">
		<h1 class="text-[2.5rem] font-extrabold">Theme Builder</h1>
	...
	<div class="layout">
		<aside class="color-controls">
			<div class="controls-container">
				...
				<!-- CSS Export Button -->
				<button class="export-css-button" onclick={() => toggleCssExportPanel()}>
		...
		<main style="background-color: {secondaryColorScale[1]?.value};" class="components-preview">
			<div class="preview-content">
				<div class="component-group">
						...
						<div class="component-container">
							<div class="component-row">
								<button
									...
									style="
                  --button-bg: {$baseColor.toLowerCase() === '#ffffff'
										? getButtonStyles(true, true).bg
										: colorScale[8]?.value}; 
                  --button-text: {$baseColor.toLowerCase() === '#ffffff'
										? getButtonStyles(true, true).text
										: getContrastColor(colorScale[8]?.value)}; 
                  --button-hover: {$baseColor.toLowerCase() === '#ffffff'
										? getButtonStyles(true, true).hover
										: colorScale[7]?.value}; 
                  {$baseColor.toLowerCase() === '#ffffff' ? 'border: 1px solid #e2e2e2;' : ''}"
								...
								<button
									...
									style="
                  --button-border: {$secondaryColor.toLowerCase() === '#ffffff'
										? '#e2e2e2'
										: secondaryColorScale[5]?.value}; 
                  --button-bg: {$secondaryColor.toLowerCase() === '#ffffff'
										? '#f0f0f0'
										: secondaryColorScale[2]?.value}; 
                  --button-hover: {$secondaryColor.toLowerCase() === '#ffffff'
										? '#e8e8e8'
										: secondaryColorScale[3]?.value}; 
                  --button-text: {$secondaryColor.toLowerCase() === '#ffffff'
										? '#333333'
										: secondaryColorScale[11]?.value}"
								>
									Secondary
								</button>
								<button
                  ...
                  --button-text: {$secondaryColor.toLowerCase() === '#ffffff'
							...
							<div class="component-row">
								<button
									...
									style="
                  --button-bg: {$baseColor.toLowerCase() === '#ffffff'
										? getButtonStyles(true, false).bg
										: colorScale[5]?.value}; 
                  --button-text: {$baseColor.toLowerCase() === '#ffffff'
										? getButtonStyles(true, false).text
										: colorScale[11]?.value}; 
                  --button-border: {$baseColor.toLowerCase() === '#ffffff'
										? '#e2e2e2'
										: colorScale[8]?.value}; 
                  --button-hover: {$baseColor.toLowerCase() === '#ffffff'
										? getButtonStyles(true, false).hover
										: colorScale[6]?.value}; 
                  {$baseColor.toLowerCase() === '#ffffff' ? 'border: 1px solid #e2e2e2;' : ''}"
								>
									Accent
								...
								<button
									class="demo-button accent-outline"
									style="
                  --button-border: {$baseColor.toLowerCase() === '#ffffff'
										? '#e2e2e2'
										: colorScale[8]?.value}; 
                  ...
                  --button-text: {$baseColor.toLowerCase() === '#ffffff'
								...
								<button
									class="demo-button accent-subtle"
									style="
                  --button-hover: {$baseColor.toLowerCase() === '#ffffff'
										? '#f5f5f5'
										: colorScale[2]?.value}; 
						...
						<div class="component-container">
							<div class="component-row">
								<span
									...
									style="
                  --badge-bg: {$baseColor.toLowerCase() === '#ffffff'
										? '#ffffff'
										: colorScale[8]?.value}; 
                  --badge-text: {$baseColor.toLowerCase() === '#ffffff'
										? '#000000'
										: getContrastColor(colorScale[8]?.value)}; 
                  {$baseColor.toLowerCase() === '#ffffff' ? 'border: 1px solid #e2e2e2;' : ''}"
									>Primary</span
								...
								<span
									...
									style="
                  --badge-bg: {$secondaryColor.toLowerCase() === '#ffffff'
										? '#f0f0f0'
										: secondaryColorScale[4]?.value}; 
                  --badge-text: {$secondaryColor.toLowerCase() === '#ffffff'
										? ''
										: secondaryColorScale[11]?.value};">Secondary</span
								>
								<span
									class="demo-badge outline"
									style="
                  --badge-border: {$baseColor.toLowerCase() === '#ffffff'
										? '#e2e2e2'
										: colorScale[8]?.value}; 
                  --badge-text: {$baseColor.toLowerCase() === '#ffffff'
										? '#333333'
										: colorScale[9]?.value};">Outline</span
								>
								<span
									class="demo-badge subtle"
									style="
                  --badge-bg: {$baseColor.toLowerCase() === '#ffffff'
										? '#f5f5f5'
										: colorScale[3]?.value}; 
                  ...
                  --badge-text: {$secondaryColor.toLowerCase() === '#ffffff'
										? '#333333'
										: secondaryColorScale[11]?.value}; 
                  --dot-color: {$baseColor.toLowerCase() === '#ffffff'
										? '#333333'
										: colorScale[8]?.value};"
								>
						...
						<div class="component-container">
							<div class="input-row">
								<div class="input-group flex-1">
									<input
										...
										class="demo-input"
										style="--input-border: {secondaryColorScale[5]
											?.value}; --input-bg: {secondaryColorScale[1]
											?.value}; --input-focus: {colorScale[8]?.value}"
									/>
								</div>
								...
								<div class="input-group flex-1">
									<input
										...
										style="--input-border: {secondaryColorScale[5]
											?.value}; --input-bg: {colorScale[3]?.value}; --input-focus: {colorScale[8]
											?.value}"
									/>
								</div>
							</div>
							...
							<div
								class="slider-container mt-4"
								style="--slider-track: {secondaryColorScale[5]
									?.value}; --slider-fill: {$baseColor.toLowerCase() === '#ffffff'
									? '#e2e2e2'
									: colorScale[8]?.value}; --slider-thumb: {$baseColor.toLowerCase() === '#ffffff'
									? '#f0f0f0'
									: colorScale[8]?.value};"
							>
							...
							<div class="controls-flex-row">
								<div class="controls-group">
									<div class="checkbox-wrapper">
										...
										/>
										<label for="demo-checkbox" style="color: {secondaryColorScale[10]?.value}"
											>Option 1</label
										>
									</div>
									<div class="checkbox-wrapper">
										...
										/>
										<label
											for="demo-checkbox-accent"
											style="color: {secondaryColorScale[10]?.value}">Option 2</label
										>
									</div>
								</div>
								...
								<div class="controls-group">
									<div class="radio-wrapper">
										...
										/>
										<label for="radio1" style="color: {secondaryColorScale[10]?.value}"
											>Selection 1</label
										>
									</div>
									<div class="radio-wrapper">
										<input
											...
											style="--radio-color: {colorScale[8]?.value}"
										/>
										<label for="radio2" style="color: {secondaryColorScale[10]?.value}"
											>Selection 2</label
										>
									</div>
								</div>
                    ...
                    --button-text: {$secondaryColor.toLowerCase() === '#ffffff'
									...
									<span
										...
										style="
                    --tooltip-bg: {$secondaryColor.toLowerCase() === '#ffffff'
											? '#f0f0f0'
											: secondaryColorScale[9]?.value}; 
                    --tooltip-text: {$secondaryColor.toLowerCase() === '#ffffff'
											? '#333333'
											: getContrastColor(secondaryColorScale[9]?.value)};"
									>
										Tooltip information
									</span>
								</div>
                    ...
                    --button-hover: {$baseColor.toLowerCase() === '#ffffff'
									...
									<span
										...
										style="
                    --tooltip-bg: {$baseColor.toLowerCase() === '#ffffff'
											? '#f0f0f0'
											: colorScale[9]?.value}; 
                    --tooltip-text: {$baseColor.toLowerCase() === '#ffffff'
											? '#333333'
											: getContrastColor(colorScale[9]?.value)};"
									>
										Accent tooltip
									</span>
								</div>
						...
						<div class="component-container">
							<div
								class="demo-card"
								style="--card-bg: {secondaryColorScale[1]
									?.value}; --card-border: {secondaryColorScale[4]?.value}"
							>
								<h3 style="color: {secondaryColorScale[11]?.value}">Card Title</h3>
								<p style="color: {secondaryColorScale[10]?.value}">
									Card with custom colors based on your selected scheme.
								</p>
								<button
									class="demo-button small primary"
									style="
                  --button-bg: {$baseColor.toLowerCase() === '#ffffff'
										? getButtonStyles(true, true).bg
										: colorScale[8]?.value}; 
                  --button-text: {$baseColor.toLowerCase() === '#ffffff'
						...
						<div class="component-container">
							<div
								class="demo-card elevated"
								style="--card-bg: {secondaryColorScale[2]
									?.value}; --card-shadow: {secondaryColorScale[4]?.value}"
							>
								...
								<div class="card-content">
									...
									<p style="color: {secondaryColorScale[10]?.value}">
										Card with custom shadow and accent highlight.
									</p>
									<button
										class="demo-button small secondary"
										style="--button-border: {secondaryColorScale[5]
											?.value}; --button-bg: {secondaryColorScale[2]
											?.value}; --button-hover: {secondaryColorScale[3]
											?.value}; --button-text: {secondaryColorScale[11]?.value}"
									>
										Action
									</button>
								</div>
						...
						<div class="component-container center-content">
							<div
								class="star-rating"
								style="--star-color: {colorScale[8]
									?.value}; --star-inactive: {secondaryColorScale[4]?.value};"
							>
						...
						<div class="component-container center-content">
							<div
								class="timer"
								style="--timer-bg: {secondaryColorScale[2]
									?.value}; --timer-border: {secondaryColorScale[4]
									?.value}; --timer-text: {secondaryColorScale[11]?.value};"
							>
								<div class="timer-display">00:03:45</div>
								<div class="timer-controls">
									<button
										class="timer-button"
										style="--button-bg: {colorScale[8]?.value}; --button-text: {getContrastColor(
											colorScale[8]?.value
										)};"
									>
										Start
									...
									<button
										class="timer-button"
										style="--button-bg: {secondaryColorScale[5]
											?.value}; --button-text: {secondaryColorScale[11]?.value};"
									>
										Reset
									</button>
						...
						<div class="component-container">
							<blockquote
								class="fancy-quote"
								style="--quote-bg: {secondaryColorScale[2]?.value}; --quote-border: {colorScale[5]
									?.value}; --quote-text: {secondaryColorScale[11]?.value};"
							>
								<div class="quote-image-container">
									<img
										class="w-full h-full grayscale object-cover rounded-md"
										src="Cat.jpg"
										alt=""
									/>
								</div>
								<div class="quote-content">
									<p style="color: {secondaryColorScale[11]?.value};">
						...
						<div class="component-container">
							<div
								class="audio-player"
								style="--player-bg: {secondaryColorScale[2]
									?.value}; --player-border: {secondaryColorScale[4]
									?.value}; --waveform-bg: {secondaryColorScale[4]
									?.value}; --waveform-fill: {colorScale[8]?.value};"
							>
								<div class="audio-controls">
									...
									<div class="audio-info" style="color: {secondaryColorScale[11]?.value};">
										...
										<div class="audio-time" style="color: {secondaryColorScale[10]?.value};">
											0:45 / 3:30
										</div>
									</div>
								</div>
								<div class="waveform">
									<div class="waveform-bars">
										{#each Array(30) as _, i}
											<div
												class="waveform-bar"
												style="height: {30 + Math.sin(i * 0.4) * 25}%; background-color: {i < 10
													? colorScale[8]?.value
													: secondaryColorScale[4]?.value};"
											></div>
										{/each}
						...
						<div class="component-container">
							...
							>
								<div class="profile-header">
									<div
										class="avatar"
										style="--avatar-bg: {colorScale[5]?.value}; color: {getContrastColor(
											colorScale[5]?.value
										)}"
									>
										JD
								...
								<div class="profile-body">
									<p style="color: {secondaryColorScale[10]?.value};">
										Created 15 projects with 5 team members recently.
									</p>
								</div>
								<div
									class="profile-footer"
									style="--footer-border: {secondaryColorScale[4]?.value};"
								>
									<button
										class="demo-button small secondary"
										style="--button-border: {secondaryColorScale[5]
									...
									<button
										class="demo-button small accent"
										style="--button-bg: {colorScale[5]?.value}; --button-text: {colorScale[11]
											?.value}; --button-border: {colorScale[8]
											?.value}; --button-hover: {colorScale[6]?.value};"
									>
										Connect
									</button>
								</div>
						...
						<div class="component-container">
							<div
								class="feature-card"
								style="--card-bg: {secondaryColorScale[1]
									?.value}; --card-border: {secondaryColorScale[4]
									?.value}; --card-accent: {colorScale[5]
									?.value}; --card-text: {secondaryColorScale[11]
									?.value}; --card-text-secondary: {secondaryColorScale[10]?.value};"
							>
								<div class="feature-card-inner">
									<div
										class="feature-icon-wrapper"
										style="background-color: {colorScale[3]?.value}; color: {colorScale[9]
											?.value}; {$baseColor.toLowerCase() === '#ffffff'
											? 'border: 1px solid #e2e2e2;'
											: ''}"
									>
										<svg
									...
									<div class="feature-footer">
										<button
											...
											style="color: {$baseColor.toLowerCase() === '#ffffff'
												? '#333333'
												: colorScale[9]?.value};"
										>
											Learn more
                ...
                --editor-btn-active: {$baseColor.toLowerCase() === '#ffffff'
									? '#f5f5f5'
									: colorScale[3]?.value}; 
                --editor-icon: {secondaryColorScale[10]?.value}; 
                --editor-icon-active: {$baseColor.toLowerCase() === '#ffffff'
									? '#333333'
									: colorScale[9]?.value};"
							>
								...
								<div
									...
									style="--editor-content-bg: {secondaryColorScale[0]
										?.value}; --editor-content-border: {secondaryColorScale[4]
										?.value}; --editor-text: {secondaryColorScale[11]?.value};"
								>
									<p style="margin-bottom: 10px;">
										This is a <span
											style="color: {$baseColor.toLowerCase() === '#ffffff'
												? '#333333'
												: colorScale[9]?.value}; font-weight: 500;">rich text editor</span
										> with custom styling.
									</p>
									<p style="margin-bottom: 10px;">
										You can format text with <span style="font-weight: bold;">bold</span>,
										<span style="font-style: italic;">italic</span>, or
							...
							>
								<div class="feature-card-inner">
									...
									<div class="feature-content">
										...
										<p class="feature-description">
											Get detailed insights and reports to help you make better decisions.
										</p>
									</div>
									<div class="feature-footer">
										<button
	...
	{#if showCssExport}
		<section
			transition:slide
			class="css-export-panel"
			style="--panel-bg: {secondaryColorScale[1]?.value}; --panel-border: {secondaryColorScale[5]
				?.value}; --panel-header-bg: {colorScale[3]?.value}; --panel-header-text: {colorScale[11]
				?.value};"
		>
			<div
				class="export-header"
				style="background: linear-gradient(to right, {colorScale[2]?.value}, {colorScale[3]
					?.value});"
			>
...
{#if showPrimaryPicker && primaryButtonPosition}
	<div
		...
		)}px; top: {primaryButtonPosition.bottom + 8}px;"
	>
		<div class="color-picker-container">
			...
			<ColorSelect bind:rgb={primaryRgb} class="custom-color-picker" />
		</div>
	</div>
{/if}
...
{#if showSecondaryPicker && secondaryButtonPosition}
	<div
		...
		style="left: {Math.min(
			...
			window.innerWidth - 256
		)}px; top: {secondaryButtonPosition.bottom + 8}px;"
	>
		<div class="color-picker-container">
			<div class="picker-header">
				<span>Base</span>
			...
			<ColorSelect bind:rgb={secondaryRgb} class="custom-color-picker" />
		</div>
	</div>
{/if}
...
<style>
	...
	.demo-card.elevated {
		...
		box-shadow:
			...
			0 0 0 1px var(--card-shadow, var(--border-color));
		padding: 0;
		overflow: hidden;
	}
